"""Tests for nonlinearly constrained problems using everest_optimizers.minimize() with method='optpp_q_nips'
...
TODO: optpp_q_nips needs to be implemented to handle the nonlinearly constrained problems.
"""
