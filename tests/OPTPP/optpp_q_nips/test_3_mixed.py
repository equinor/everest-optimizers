...
@pytest.mark.xfail(reason="Graceful failure for infeasible problems is not yet implemented.")
...
@pytest.mark.xfail(reason="Graceful failure for unbounded problems is not yet implemented.")
