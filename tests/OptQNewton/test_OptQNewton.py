...
def test_pyopttpp_import():
    ...
    if not pyopttpp_available:
        ...
        print(f"Could not import pyopttpp from {pyopttpp_build_dir}. Make sure the module is built.")
        ...
        if not so_file_found:
            ...
            print("Make sure you've built the module according to the instructions in "
