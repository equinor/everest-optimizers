...
def test_serial_dense_vector():
    ...
    # Test __getitem__
    assert np.isclose(vector[1], 2.5), f"Expected element 1 to be 2.5, but got {vector[1]}"

    # Test __setitem__
    vector[1] = 9.9
    assert np.isclose(vector[1], 9.9), f"Expected element 1 to be 9.9 after setitem, but got {vector[1]}"
