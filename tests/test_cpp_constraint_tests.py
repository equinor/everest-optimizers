...
exposed via pybind11 bindings in pyopttpp.cpp.
"""
...
@pytest.mark.skipif(not PYOPTTPP_AVAILABLE, 
                   reason=f"pyopttpp not available: {IMPORT_ERROR if not PYOPTTPP_AVAILABLE else ''}")
class TestCppConstraintTests:
    ...
    def test_linear_equality_constraint_multiple(self):
        ...
        result = pyopttpp.run_linear_eq_test2()
    ...
    def test_linear_inequality_constraint_simple(self):
        ...
        result = pyopttpp.run_linear_ineq_test1()
    ...
    def test_bounds_constraint_asymmetric(self):
        ...
        result = pyopttpp.run_bounds_test2()
    ...
    def test_mixed_linear_constraints(self):
        ...
        result = pyopttpp.run_mixed_linear_test1()
    ...
    def test_diagnostic_single_matrix(self):
        ...
        result = pyopttpp.run_diagnostic_single_matrix()
    ...
    def test_diagnostic_separate_compounds(self):
        ...
        result = pyopttpp.run_diagnostic_separate_compounds()
    ...
    def test_diagnostic_two_constraints(self):
        ...
        result = pyopttpp.run_diagnostic_two_constraints()
    ...
    def test_diagnostic_one_constraint(self):
        ...
        result = pyopttpp.run_diagnostic_one_constraint()
    ...
    def test_diagnostic_different_start(self):
        ...
        result = pyopttpp.run_diagnostic_different_start()
    ...
    def test_comprehensive_test_runner(self):
        ...
        if implemented_tests:
            passed_implemented = sum(1 for _, result in implemented_tests if result.success)
            print(f"Passed implemented tests: {passed_implemented}/{len(implemented_tests)}")
    ...
    def test_constraint_violation_utility(self):
        ...
        x = pyopttpp.SerialDenseVector(2)
        x[0] = 1.0
        x[1] = 2.0
        ...
        try:
            violation = pyopttpp.check_constraint_violation(x, None)
...
@pytest.mark.skipif(not PYOPTTPP_AVAILABLE, 
                   reason=f"pyopttpp not available: {IMPORT_ERROR if not PYOPTTPP_AVAILABLE else ''}")
def test_run_all_constraint_tests_standalone():
...
if __name__ == "__main__":
    ...
    if PYOPTTPP_AVAILABLE:
        ...
        print(f"Cannot run tests - pyopttpp not available: {IMPORT_ERROR}")