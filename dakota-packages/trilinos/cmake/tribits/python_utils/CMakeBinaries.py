...
cmake_min_binaries = (
    (
        "linux2",
        cmake_baseurl + "/vCVS/cmake-" + cmake_version_min + "-Linux-i386.tar.gz",
    ),
    (
        "darwin",
        cmake_baseurl + "/vCVS/cmake-" + cmake_version_min + "-Darwin-universal.tar.gz",
    ),
...
cmake_release_binaries = (
    (
        "linux2",
        cmake_baseurl + "/v2.8/cmake-" + cmake_version_release + "-Linux-i386.tar.gz",
    ),
    (
        "darwin",
        cmake_baseurl
    ...
    (
        "win32",
        cmake_baseurl + "/v2.8/cmake-" + cmake_version_release + "-win32-x86.zip",
    ),
)
...
cmake_rc_binaries = (
    (
        "linux2",
        cmake_baseurl + "/v2.8/cmake-" + cmake_version_rc + "-Linux-i386.tar.gz",
    ),
    (
        "darwin",
        cmake_baseurl + "/v2.8/cmake-" + cmake_version_rc + "-Darwin-universal.tar.gz",
    ),
...
cmake_dev_binaries = (
    (
        "linux2",
        cmake_baseurl + "/vCVS/cmake-" + cmake_version_dev + "-Linux-i386.tar.gz",
    ),
    (
        "darwin",
        cmake_baseurl + "/vCVS/cmake-" + cmake_version_dev + "-Darwin-universal.tar.gz",
    ),
