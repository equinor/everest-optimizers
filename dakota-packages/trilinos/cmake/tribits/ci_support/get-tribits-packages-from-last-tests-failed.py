...
usageHelp = r"""get-tribits-packages-from-last-tests-failed.py --deps-xml-file=<file> \
...
clp.add_option(
    "--last-tests-failed-file",
    dest="lastTestsFailedFile",
    type="string",
    default=None,
...
packageNames = getPackageNamesFromLastTestsFailedLines(
    trilinosDependencies, lastTestsFailedLines,
)
