...
argument '--cmake-version=master'.
 """
    ...
    def echoExtraCmndLineOptions(self, inOptions):
        ...
        cmndLine += (
            "  --extra-configure-options='" + inOptions.extraConfigureOptions + "' \\\n"
        )
        cmndLine += (
            "  --use-native-cmake-config='" + inOptions.cmakeNativeConfig + "' \\\n"
        )
    ...
    def doConfigure(self):
        ...
        if cmakeCmd is not None:
            ...
            raise Exception(
                "Could not find 'cmake' in PATH and --use-native-cmake-config=on!",
            )
        else:
    ...
    def doBuild(self):
        ...
        echoRunSysCmnd(
            "make " + getParallelOpt(self.inOptions, "-j") + self.inOptions.makeOptions,
        )
    ...
    def getFinalInstructions(self):
        return (
            """
To use the installed version of cmake-"""
