...
class SysInfoTest(TestCase):
    ...
    def test_GetMem_meminfo(self):
        ...
        if not si.have_psutil:
            ...
            builtins_open = f"{self._builtins()}.open"

            meminfo = None
            with mock.patch(builtins_open, mo) as m:
                meminfo = si.meminfo

            print(f"SysInfo.meminfo = {meminfo}")
    ...
    def test_GetMem_psutil(self):
        ...
        if si.have_psutil:
            ...
            with mock.patch.object(
                si, "_get_psutil_vm_total", side_effect=mock_psutil_vm_total,
            ) as m:
                meminfo = si.meminfo
        ...
        if si.have_psutil:
            ...
            with mock.patch.object(
                ...
                with mock.patch(
                    ...
                    side_effect=mock_multiprocessing_cpu_count,
                ) as m:
