...
op = matrix(10)
g = vector_type.full(10, 0.0)
x = vector_type.full(10, 1.0)
obj = norm2Obj(op, g)
c = Constraint()
a = vector_type.full(10, 1.0)
b = vector_type.full(10, 1.0)
a.scale(2.0)
np.testing.assert_equal(a.norm(), 2 * np.sqrt(10))
a.zero()
np.testing.assert_equal(a.norm(), 0.0)

a.axpy(1.0, b)
np.testing.assert_equal(a.norm(), np.sqrt(10))
np.testing.assert_equal(a.dot(b), 10.0)

b.setScalar(2.0)
a = b
np.testing.assert_equal(a.apply(b), 40.0)
np.testing.assert_equal(b.norm(), 2 * np.sqrt(10))
np.testing.assert_equal(b[0], 2.0)
b[0:2] = [1.0, 3.0]
np.testing.assert_equal(b[0:2], [1.0, 3.0])
